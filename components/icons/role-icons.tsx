...
export const TopRoleIcon: RoleIconComponent = ({
  className,
  width = 24,
  height = 24,
  ...props
...
export const JungleRoleIcon: RoleIconComponent = ({
  className,
  width = 24,
  height = 24,
  ...props
...
export const SupportRoleIcon: RoleIconComponent = ({
  className,
  width = 24,
  height = 24,
  ...props
...
export const MidRoleIcon: RoleIconComponent = ({
  className,
  width = 24,
  height = 24,
  ...props
...
export const BottomRoleIcon: RoleIconComponent = ({
  className,
  width = 24,
  height = 24,
  ...props
